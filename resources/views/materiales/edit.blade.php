                    ...
                    <div>
                            ...
                            <select name="categoria_elemento_id" 
                                ...
                                @foreach($categoriasElementos as $categoria)
                                    <option value="{{ $categoria->id_categoria_elemento }}" class="bg-primary-800" {{ old('categoria_elemento_id', $material->categoria_elemento_id) == $categoria->id_categoria_elemento ? 'selected' : '' }}>
