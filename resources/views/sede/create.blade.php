...
<div class="flex items-center justify-between mb-8">
    <div>
        <h1 class="text-3xl font-bold text-white mb-2">Crear Nueva Sede</h1>
        <p class="text-primary-300">Agrega una nueva sede al sistema BoxWare</p>
    </div>
...
<div class="max-w-4xl mx-auto">
    <div class="glass-effect rounded-xl border border-primary-700 overflow-hidden">
        ...
        <!-- Form Content -->
        <div class="p-8">
            <form method="POST" action="{{ route('sede.store') }}" class="space-y-8">
                @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="direccion_sede" 
                                   ...
                                   value="{{ old('direccion_sede') }}" required>
                        ...
                        <div>
                            ...
                            <select name="centro_id" 
                                ...
                                @foreach($centros as $centro)
                                    <option value="{{ $centro->id_centro }}" class="bg-primary-800" {{ old('centro_id') == $centro->id_centro ? 'selected' : '' }}>
