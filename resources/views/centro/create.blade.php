...
@section('title', 'Crear Centro | BoxWare')
...
<div class="flex items-center mb-8">
    ...
    <div>
        <h1 class="text-3xl font-bold text-white mb-1">Crear Nuevo Centro</h1>
        <p class="text-primary-300">Completa el formulario para crear un nuevo centro</p>
    </div>
</div>
...
<div class="glass-effect rounded-xl border border-primary-700 overflow-hidden">
    ...
    <!-- Form Content -->
    <div class="p-8">
        <form action="{{ route('centro.store') }}" method="POST" class="space-y-8">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="col-span-2">
                    ...
                    <input type="text" id="nombre_centro" name="nombre_centro" value="{{ old('nombre_centro') }}" 
            ...
            <div class="flex justify-end space-x-4 pt-4 border-t border-primary-700">
                ...
                <button type="submit" class="px-6 py-3 bg-accent-600 hover:bg-accent-500 text-white rounded-lg font-medium transition-all duration-200">
                    <i class="fas fa-save mr-2"></i> Guardar Centro
                </button>
            </div>
        </form>
    </div>
