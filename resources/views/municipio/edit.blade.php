...
<div class="max-w-xl mx-auto bg-white rounded-xl shadow-lg p-8">
    <h2 class="text-2xl font-bold mb-6">Editar Municipio</h2>
    <form method="POST" action="{{ route('municipio.update', $municipio->id_municipio) }}">
        @csrf
        @method('PUT')
        <div class="mb-4">
            <label class="block text-gray-700 font-semibold mb-2">Nombre del Municipio</label>
            <input type="text" name="nombre_municipio" class="w-full border rounded-lg px-4 py-2 focus:ring-primary-500 focus:border-primary-500" required value="{{ old('nombre_municipio', $municipio->nombre_municipio) }}">
        </div>
        <div class="mb-6">
        ...
        <div class="flex justify-end">
            <a href="{{ route('municipio.index') }}" class="mr-4 px-4 py-2 rounded-lg bg-gray-200 text-gray-700 font-semibold hover:bg-gray-300">Cancelar</a>
