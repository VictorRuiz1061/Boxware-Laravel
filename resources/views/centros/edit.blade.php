...
<div class="max-w-xl mx-auto bg-white rounded-xl shadow-lg p-8">
    ...
    <form method="POST" action="#">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nombre_centro" class="w-full border rounded-lg px-4 py-2 focus:ring-primary-500 focus:border-primary-500" required value="">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="municipio_id" class="w-full border rounded-lg px-4 py-2 focus:ring-primary-500 focus:border-primary-500" required value="">
        </div>
        <div class="mb-4">
