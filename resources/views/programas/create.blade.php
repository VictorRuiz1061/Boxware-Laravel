...
<div class="flex items-center justify-between mb-8">
    <div>
        <h1 class="text-3xl font-bold text-white mb-2">Crear Nuevo Programa</h1>
        <p class="text-primary-300">Agrega un nuevo programa al sistema BoxWare</p>
    </div>
...
<div class="max-w-4xl mx-auto">
    <div class="glass-effect rounded-xl border border-primary-700 overflow-hidden">
        ...
        <!-- Form Content -->
        <div class="p-8">
            <form method="POST" action="{{ route('programas.store') }}" class="space-y-8">
                @csrf
                        ...
                        <div>
                            ...
                            <select name="area_id" 
                                ...
                                @foreach($areas as $area)
                                    <option value="{{ $area->id_area }}" class="bg-primary-800" {{ old('area_id') == $area->id_area ? 'selected' : '' }}>
