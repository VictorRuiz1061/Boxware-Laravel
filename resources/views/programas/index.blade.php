...
<div class="flex items-center justify-between mb-6">
    <h2 class="text-2xl font-bold">Programas</h2>
    ...
    <table class="min-w-full divide-y divide-gray-200">
        <thead>
            <tr>
                ...
                <th class="px-4 py-2 text-left text-xs font-bold text-gray-700 uppercase">area_id</th>
        ...
        <tbody>
            @forelse($programas as $programa)
                <tr>
                    ...
                    <td class="px-4 py-2">{{ $programa->area_id }}</td>
                    <td class="px-4 py-2">
                        @if($programa->estado)
