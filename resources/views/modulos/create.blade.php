...
<div class="flex items-center justify-between mb-8">
    <div>
        <h1 class="text-3xl font-bold text-white mb-2">Crear Módulo</h1>
        <p class="text-primary-300">Añade un nuevo módulo al sistema BoxWare</p>
    </div>
...
<div class="max-w-4xl mx-auto">
    <div class="glass-effect rounded-xl border border-primary-700 overflow-hidden">
        ...
        <!-- Form Content -->
        <div class="p-8">
            <form method="POST" action="{{ route('modulos.store') }}" class="space-y-8">
                @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="descripcion_ruta" 
                                   ...
                                   value="{{ old('descripcion_ruta') }}" required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <select name="es_submenu" 
                                ...
                                <option value="0" class="bg-primary-800" {{ old('es_submenu') == 0 ? 'selected' : '' }}>No</option>
                                <option value="1" class="bg-primary-800" {{ old('es_submenu') == 1 ? 'selected' : '' }}>Sí</option>
                            </select>
                            @error('es_submenu')
                                <p class="mt-2 text-red-400 text-sm flex items-center">
                                    <i class="fas fa-exclamation-triangle mr-2"></i>{{ $message }}
                            ...
                            <select name="modulo_padre_id" 
                                ...
                                @if(isset($modulos))
                                    @foreach($modulos as $modulo)
                                        <option value="{{ $modulo->id_modulo }}" class="bg-primary-800" {{ old('modulo_padre_id') == $modulo->id_modulo ? 'selected' : '' }}>
